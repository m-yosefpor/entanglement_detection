\begin{figure}
    ...
    \end{subfigure}
    \caption{  شاهد درهم تنیدگی فضای حالت ها را به دو زیر فضا افراز میکند و  می تواند بخشی یا همه ی حالت های در هم تنیده را تشخیص دهد. شاهد درهم تندیگی می تواند خطی یا غیر خطی باشد (شکل آ). معیار پرز-هورودکی یک شاهد لازم و کافی برای سیستم دو کیبوبیت است. این شاهد فضای حالت ها را به طور کامل به دو بخش فقط درهم تنیده و فقط جداپذیر افراز می کند (شکل ب).}
    \label{fig:witnesses}
\end{figure}
